export const HTTP_STEP_METADATA = {
  ...
  'reservation_journey.concert.recommended': { route: 'GET /concerts/recommended?sort=latest&limit={limit}', service: 'concert-service' },
  'reservation_journey.concert.detail': { route: 'GET /concerts/{concertId}', service: 'concert-service' },
  'reservation_journey.concert.calendar': { route: 'GET /concerts/{concertId}/calendar?yearMonth=YYYY-MM', service: 'concert-service' },
  'reservation_journey.concert.date_performances': { route: 'GET /concerts/{concertId}/dates/{date}/performances', service: 'concert-service' },
  'reservation_journey.concert.seat_map': { route: 'GET /performances/{performanceId}/seat-map', service: 'concert-service' },
...
export const RESERVATION_JOURNEY_STEPS = [
  'reservation_journey.concert.recommended',
  'reservation_journey.concert.detail',
  'reservation_journey.concert.calendar',
  'reservation_journey.concert.date_performances',
  'reservation_journey.concert.seat_map',
